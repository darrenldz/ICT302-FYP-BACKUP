...
/* harmony default export */ __webpack_exports__["default"] = ({
    methods: {
        submit: function submit() {
            ...
            axios.post('/nova-vendor/import-csv/upload-csv', form, { 'Content-Type': 'multipart/form-data' }).then(function (res) {
    ...
    [
      ...
      _c("card", { staticClass: "p-6" }, [
        _c("div", { staticClass: "mb-4 flex" }, [
          _c("span", { staticClass: "mr-3" }, [_vm._v("Format:")]),
          _vm._v(" "),
          _c("pre", [
            _vm._v("starts_at,ends_at"),
            _c("br"),
            _vm._v("1/11/2019 13:20,1/11/2019 14:00"),
            _c("br"),
            _vm._v("2/11/2019 13:20,2/11/2019 14:00")
          ])
        ]),
        _vm._v(" "),
        _c(
          ...
          [
            _c("div", { staticClass: "mb-6" }, [
              _c("input", {
                attrs: { type: "file", id: "uploadFile", required: "" }
              })
            ]),
            _vm._v(" "),
            _c(
              ...
              {
                staticClass:
                  "border px-4 py-2 hover:bg-black hover:text-white uppercase"
              },
              [_vm._v("Submit")]
            )
          ]
